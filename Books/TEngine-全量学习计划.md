...
| 阶段      | 内容                                      | 预计      | 状态     | 完成日 |
| ------- | --------------------------------------- | ------- | ------ | --- |
| Phase 0 | 环境与总览                                   | 0.5～1 天 | 🟦 进行中 |     |
| Phase 1 | 启动链 + 模块骨架                              | 3～4 天   | 🟦 进行中 |     |
...
> 深度参考：[Procedure 启动流程详解](../知识/Procedure启动流程详解.md)

### 必读（按顺序勾选）

- [x] `GameScripts/GameEntry.cs`
...
- 制定全量学习计划文档
- 开始 Phase 1：跟读 GameEntry / ModuleSystem / RootModule / UpdateDriver / Procedure 入口
...
| 类型               | 路径                                                               |
| ---------------- | ---------------------------------------------------------------- |
| Procedure 深度拆解     | [Procedure启动流程详解.md](../知识/Procedure启动流程详解.md)                   |
